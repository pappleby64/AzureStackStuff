...
| _artifactsLocation | Blob store where all deployment artifacts are stored | string |  https://raw.githubusercontent.com/Azure/AzureStack-QuickStart-Templates/master/sql-2016-alwayson| _artifactsLocationSasToken | sas token for artifact location if requires | secure string |  
